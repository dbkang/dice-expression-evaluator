...
// otherwise they return an object in the form of { tokens: ts, reste: str } where ts is an array of tokens
// that were matched and rest is the remainder of string after those tokens are removed.

// matches dice expresions in the given string and converts them to DiceTokens
...
// Given dice expression in string, return an array of objects, each of which is an instance
// of Dice or an instance of Constant.
//
// The basic algorithm relies on the fact that in a dice expression, terms, whether dice or
// constant expressions and operators alternate with potentially spaces between them.  therefore
